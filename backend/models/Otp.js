...
const MobileService = require("../services/mobile_service");
...
otpSchema.pre("save", async function (next) {
  ...
  // await MobileService.sendOtpMobile(this.otp);
  next();
});

const Otp = mongoose.model(Constants.DB_COLLECTIONS.OTPS, otpSchema);
